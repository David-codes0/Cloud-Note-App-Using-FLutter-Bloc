...
class AuthStateEmailAlreadySent extends AuthState {
  const AuthStateEmailAlreadySent({required bool isLoading})
      : super(isLoading: isLoading);
}
...
class AuthStateLoggedOut extends AuthState with EquatableMixin {
  ...
  List<Object?> get props => [
        exception,
        isLoading
      ]; // the log out state in itself doesnt have to carry anything
}
